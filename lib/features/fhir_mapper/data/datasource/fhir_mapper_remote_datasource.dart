...
abstract class FhirMapperRemoteDatasource {
...
class FhirMapperRemoteDatasourceImpl implements FhirMapperRemoteDatasource {
  FhirMapperRemoteDatasourceImpl(Dio dio)
      : _dio = dio
          ..interceptors.add(
            LogInterceptor(
              request: true,
