...
/// Unified repository for all FHIR records operations
...
class RecordsRepository {
  ...
  /// Get timeline resources with unified pagination
  ...
  /// Get related resources for encounter with caching
  ...
  /// Import FHIR Bundle with individual source IDs
  ...
  /// Parse FHIR Bundle resources (legacy method for backward compatibility)
  Map<String, List<Map<String, dynamic>>> _parseBundleResources(
      String bundleJson) {
    ...
    try {
      ...
      if (entries != null) {
          ...
          if (entry is Map<String, dynamic>) {
            ...
            if (resourceWrapper != null) {
              ...
              if (resource != null) {
                final resourceType = resource['resourceType'] as String?;
                if (resourceType != null) {
                  resources.putIfAbsent(resourceType, () => []);
        ...
        logger.d('Parsed ${resources.length} resource types from bundle');
      }
    } catch (e) {
      logger.e('Error parsing bundle: $e');
    }
