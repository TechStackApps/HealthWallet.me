// health_wallet/features/document_scanner/presentation/widgets/save_fhir_media_dialog.dart
...
class _SaveFhirMediaDialogState extends State<SaveFhirMediaDialog> {
  ...
  void initState() {
    ...
    _sourceIdController.text = 'document-scanner';
  }
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Save ${widget.documentCount} document${widget.documentCount > 1 ? 's' : ''} as FHIR Media resource${widget.documentCount > 1 ? 's' : ''} in your medical records.',
                ...
                Container(
                  ...
                  child: const Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text(
                        'Documents will be saved as FHIR Media resources in your medical records timeline and can be referenced in encounters.',
