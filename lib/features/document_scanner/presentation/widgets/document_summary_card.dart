      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (scannedCount > 0)
              Text('• $scannedCount scanned image${scannedCount > 1 ? 's' : ''}'),
            if (importedImagesCount > 0)
              Text('• $importedImagesCount imported image${importedImagesCount > 1 ? 's' : ''}'),
            if (importedPdfsCount > 0)
              Text('• $importedPdfsCount imported PDF${importedPdfsCount > 1 ? 's' : ''}'),
            const SizedBox(height: 8),
            Text(
